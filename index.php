...
$app->post('/register', function() use ($app, $log) {
    ...
    $valueList = array('firstName' => $firstName, 'lastName' => $lastName, 'email' => $email, 'phone' => $phone);
...
$app->get('/passwordReset', function() use ($app, $log) {
    //
    $result = mail("vhohin@gmail.com", "Password confirmation", "Your login: kuku \nYour password: no known ","From: tors@gmail.com \r\n");
    $app->render('passwordReset.html.twig');
});


$app->post('/passwordReset', function() use ($app, $log) {
